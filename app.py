...
if AUDIO_INPUT_CHANNEL == "microphone":
    ...
    from services.conversation_channels.input.microphone_input_channel_service import run_microphone_mode
    run_microphone_mode()
else:
    ...
    from services.conversation_channels.input.twilio_input_channel_service import app  # app is the FastAPI instance
